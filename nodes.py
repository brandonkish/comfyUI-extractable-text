...
class BKTSVRandomPrompt:
    ...
    @classmethod
    def IS_CHANGED(self, tsv_file_path, seed,  prompt_name_search = None):
        return float("nan")
    ...
    def process(self, tsv_file_path, seed, prompt_name_search = None):
        self.name = ""
        ...
        for tag in tag_manager.get_all_tags():
                ...
                pos_prompt, neg_prompt, prompt_name, prompt_idx = selected_prompt
                ...
                selected_prompt = (pos_prompt, neg_prompt, prompt_name, prompt_idx)
